import{f as w,b as P,s as u,o as R,N as C,P as H}from"./tui-pagination-914c2d3b.js";const k="favoriteCocktails",I=document.querySelector(".cardlist"),q="cocktails/lookup/",x="id",l=JSON.parse(localStorage.getItem(k))??[];let d,n;const A={disabledScroll(){document.body.style.cssText=`
    overflow: hidden;
