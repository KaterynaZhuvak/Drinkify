import{f as $,b as T,s as u,o as _,N as C,P as H}from"./tui-pagination-6d8529db.js";const g="favoriteCocktails",I=document.querySelector(".cardlist"),q="cocktails/lookup/",M="id",l=JSON.parse(localStorage.getItem(g))??[];let d,n;const x={disabledScroll(){document.body.style.cssText=`
    overflow: hidden;
