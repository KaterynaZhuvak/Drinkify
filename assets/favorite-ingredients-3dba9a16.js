import{s as f,P as h,b as y,N as I}from"./tui-pagination-914c2d3b.js";const l=document.querySelector(".favorite-ingredients-list"),u=document.querySelector(".sorry-ingredients"),g=document.querySelector(".pagination-main"),s=JSON.parse(localStorage.getItem("KEY_FAVORITE_INGREDIENTS"))??[];let S=1,a=6,m=4;screen.width>=1280&&(m=7);u.classList.add("hidden");c(s,l);s.length||u.classList.remove("hidden");l.addEventListener("click",E);function c(i,e){e.innerHTML="",g.innerHTML="",i.length<=a?e.innerHTML=i.map(n=>{let t="Alcoholic";return n.abv==="0"&&(t="Non-alcoholic"),`<li class="in-card" data-id=${n.id}>
