import{f as $,b as T,s as d,o as _,P as R}from"./tui-pagination-2a846cb1.js";const p="favoriteCocktails",I=document.querySelector(".cardlist"),C="cocktails/lookup/",q="id",l=JSON.parse(localStorage.getItem(p))??[];let g,n;const A={disabledScroll(){document.body.style.cssText=`
    overflow: hidden;
