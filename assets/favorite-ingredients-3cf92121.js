import{s as f,P as h,b as y,N as I}from"./tui-pagination-5a898e46.js";const l=document.querySelector(".favorite-ingredients-list"),c=document.querySelector(".sorry-ingredients"),u=document.querySelector(".tui-pagination"),n=JSON.parse(localStorage.getItem("KEY_FAVORITE_INGREDIENTS"))??[];let S=1,a=6,m=4;screen.width>=1280&&(m=7);c.classList.add("hidden");r(n,l);n.length||c.classList.remove("hidden");l.addEventListener("click",E);function r(i,e){e.innerHTML="",u.innerHTML="",i.length<=a?e.innerHTML=i.map(s=>{let t="Alcoholic";return s.abv==="0"&&(t="Non-alcoholic"),`<li class="in-card" data-id=${s.id}>
...
</li>`}).join(""):(b(n,l,a,S),k(n,u,a))}function b(i,e,s,t){e.innerHTML="",t--;let o=s*t,d=o+s,g=i.slice(o,d);return r(g,l)}function k(i,e,s){e.innerHTML="";const t={totalItems:i.length,itemsPerPage:s,visiblePages:m,page:1,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="tui-page-btn btnStyle">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected btnStyleActive">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}} btnStyle"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}} btnStyle"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};new h(u,t).on("beforeMove",d=>{const{page:g}=d;b(n,l,a,g)})}function E(i){if(i.target.classList.contains("btn-learn-more")){const e=v(i.target);y.create(`<div id="modal-ingredients" class="modal-in">
