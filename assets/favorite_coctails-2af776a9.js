import{f as $,b as T,s as d,o as _,P as R}from"./tui-pagination-a026f945.js";const p="favoriteCocktails",I=document.querySelector(".cardlist"),C="cocktails/lookup/",q="id",l=JSON.parse(localStorage.getItem(p))??[];let g,n;const A={disabledScroll(){document.body.style.cssText=`
    overflow: hidden;
  ...
  <button type="button" class="button-card favorite add-to-fav-cockt" data-id="${t}">
   ...
   <button type="button" class="button-card back close-cocktail-modal-back">Back</button></div>
        ...
        <img src="${t}" loading="lazy" class="cardlist-img" alt="${a}" onerror="this.onerror=null;this.src='${B}';" width=300>
