import{f as w,b as _,s as u,o as P,N as C,P as H}from"./tui-pagination-e046eb5b.js";const g="favoriteCocktails",I=document.querySelector(".cardlist"),q="cocktails/lookup/",M="id",l=JSON.parse(localStorage.getItem(g))??[];let d,n;const R={disabledScroll(){document.body.style.cssText=`
    overflow: hidden;
