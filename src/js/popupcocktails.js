  ...
  <div class="box">
    <div class="picture">
      <img
        src="${drinkThumb}"
        alt="${drink}"
        onerror="this.onerror=null;this.src='../img/rafiki.jpg';"
      />
    </div>
    <div>
      ...
      <ul class="list-card ingredients-list">
        ${ingredientsRaw}
      </ul>
    </div>
  </div>
  <p class="caption-card">Instructions:</p>
  <p class="text desc-card">${instructions}</p>
  <div class="container-button">
    <button type="button" class="button-card favorite favorite-theme-light">
      add to favorite
    </button>
    <button
      type="button"
      class="button-card back-theme-light back close-cocktail-modal-back"
    >
      Back
    </button>
  </div>
